...
class TestPaymentImputation(set_up.SetUp):
    ...
    def setUp(self):
        ...
        self.imputation = self.env['payment.imputation.line'].create({
            ...
            'move_line_id': self.invoice.move_id.line_ids.filtered(lambda x: x.account_id == self.invoice.account_id).id
        })
    ...
    def test_partial_payment_partial_invoice(self):
        ...
        self.customer_payment.advance_amount = 200
        self.customer_payment.post_l10n_ar()
    ...
    def test_higher_payment_amount_than_invoices(self):
        ...
        self.customer_payment.advance_amount = 1000
        ...
        assert self.customer_payment.payment_imputation_difference == 0.00
